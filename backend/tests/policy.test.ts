...
import { DEFAULT_ADMINISTRATOR_ID } from "../src/services/users.js";

const admin: Actor = { id: "admin-1", role: "Admin", accessibleSpaceIds: "all" };
const member: Actor = { id: "member-1", role: "Member", accessibleSpaceIds: new Set(["s1", "s2"]) };
const memberNoGrants: Actor = { id: "member-2", role: "Member", accessibleSpaceIds: new Set() };
